...
import com.whp.hms.mapper.ImgLogDao;
...
public class ImgLogServiceImpl implements ImgLogService {
    ...
    @Override
    public List<ImgLog> queryAdminList(Integer offset, Integer limit) {
        return this.imgLogDao.queryAdminList(offset, limit);
    }

    @Override
    public Integer queryAdminCount() {
        return this.imgLogDao.queryAdminCount();
    }

    @Override
    public boolean batchDelImg(List<Integer> ids)
    {
        return this.imgLogDao.batchDelImg(ids) > 0;
    }

    @Override
    public boolean delAllImg() {
        return this.imgLogDao.delAllImg() > 0;
    }
}