...
public class LiveRecordServiceImpl implements LiveRecordService {
    ...
    @Override
    public List<LiveRecord> queryAdminList(Integer offset, Integer limit, String nickname, String room) {
        return this.liveRecordDao.queryAdminList(offset, limit, nickname, room);
    }

    @Override
    public Integer queryAdminCount(String nickname, String room) {
        return this.liveRecordDao.queryAdminCount(nickname, room);
